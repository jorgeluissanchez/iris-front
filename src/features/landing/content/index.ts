...
export const landingContent = {
  ...
  horizontalScroll: {
    panels: [
      ...
      },
      {
        ...
        description: 'Integración con herramientas modernas, dashboard interactivo y reportes en tiempo real para una experiencia de evaluación sin precedentes.',
        cta: 'Conocer más',
      },
    ],
  },
  ...
  developers: {
    ...
    team: [
      { name: 'Juan Povea F', role: 'Backend Leader' },
      { name: 'Jorge Sánchez B', role: 'Frontend Leader' },
      { name: 'Alejandra Valencia R', role: 'Backend Developer' },
      { name: 'Carlos López G', role: ' UI/UX Leader - Frontend Developer' },
      { name: 'Yovany Zhu Ye', role: 'Full Stack Developer' },
      { name: 'Jhonatan Romero P', role: 'Frontend Developer' },
      { name: 'Jesús Cantillo G', role: 'Backend Developer' },
