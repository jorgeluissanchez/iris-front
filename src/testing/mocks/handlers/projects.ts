...
export const projectsHandlers = [
  ...
  http.get(`${env.API_URL}/projects/:projectId`, async ({ params, cookies }) => {
    await networkDelay();
  ...
  http.patch(`${env.API_URL}/projects/:projectId`, async ({ params, request, cookies }) => {
    await networkDelay();
  ...
  http.delete(`${env.API_URL}/projects/:projectId`, async ({ params, cookies }) => {
    await networkDelay();
    ...
    try {
      ...
      const projectId = params.projectId as string;
      const project = db.project.delete({ where: { id: { equals: projectId } } });
  ...
  // Projects by event
  http.get(`${env.API_URL}/projects/by-event/:eventId`, async ({ params, cookies, request }) => {
    await networkDelay();
